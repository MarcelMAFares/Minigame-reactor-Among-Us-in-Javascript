...
startReactor = {
    ...
    audio: {
        ...
        victory: ['victory.mp3'],
        impostor_wins: ['impostor_wins.mp3'],
        ...
        loadAudios() {
            ...
            startReactor.audio.victory = startReactor.audio.loadAudio(startReactor.audio.victory)
            startReactor.audio.impostor_wins = startReactor.audio.loadAudio(startReactor.audio.impostor_wins)
    ...
    play(index) {
        ...
        if (startReactor.isTheRightCombination(startReactor.playerCombination.length)) {
            ...
            if (startReactor.playerCombination.length == startReactor.combinationMaxPosition) {
                ...
                var content = '<img src = victory.png height= 500 width= 500>'
                setTimeout(() => {
                    document.getElementsByTagName('body')[0].innerHTML = content;
                    startReactor.audio.victory.play()
            ...
            var content = '<img src = impostor.png height= 500 width= 500>'
            setTimeout(() => {
              startReactor.audio.impostor_wins.play()
              document.getElementsByTagName('body')[0].innerHTML = content;
              let btn = document.createElement("button");
              btn.innerHTML = "Play Again";
              btn.onclick = function () {
